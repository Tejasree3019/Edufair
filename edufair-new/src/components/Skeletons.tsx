...
export function DashboardSkeleton() {
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="bg-gradient-to-r from-slate-800 to-slate-700 rounded-lg p-6 animate-pulse">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {[1, 2, 3].map(i => (
          <div key={i} className="bg-slate-800/50 rounded-lg p-6 shadow animate-pulse border border-white/10">
      ...
      {/* Applications */}
      <div className="bg-slate-800/50 rounded-lg p-6 shadow animate-pulse border border-white/10\">
