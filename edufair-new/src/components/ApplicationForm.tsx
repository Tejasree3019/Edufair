    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Scholarship Application Form</h1>
          {scholarshipName && <p className="text-lg text-indigo-600 font-semibold">{scholarshipName}</p>}
          <p className="text-gray-600 mt-2">Fill out this form to apply for the scholarship</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <h2 className="col-span-full text-2xl font-bold text-gray-800 mb-2">Personal Information</h2>
            ...
            {/* Location */}
            <h2 className="col-span-full text-2xl font-bold text-gray-800 mt-6 mb-2">Location</h2>
            ...
            <h2 className="col-span-full text-2xl font-bold text-gray-800 mt-6 mb-2">Academic Information</h2>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Academic Score (GPA/%) *</label>
              <input
                type="number"
                name="academicScore"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Entrance Test Score (JEE/CAT etc) *</label>
              <input
                type="number"
                name="testScore"
            ...
            <h2 className="col-span-full text-2xl font-bold text-gray-800 mt-6 mb-2">Financial Information</h2>
            ...
            {/* Essays & Additional */}
            <h2 className="col-span-full text-2xl font-bold text-gray-800 mt-6 mb-2">Additional Information</h2>
            ...
            <div className="col-span-full">
              <label className="block text-sm font-medium text-gray-700 mb-2">Referee Email (Teacher/Principal)</label>
              <input
                type="email"
                name="refereeEmail"
